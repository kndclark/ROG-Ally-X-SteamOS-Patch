...
## Key Tests
- \	est_thresholds.py\: Demonstrates the hardware brightness jumping bug by sweeping the slider.
- \	est_flicker.py\: A dual-loop test to isolate software color scaling from hardware brightness scaling.
- \	est_real_zones.py\: Sweeps through the 5 actual active LED zones on the Ally X.
